...
class wc4bp_groups_woo_elem_integration {
	...
	public function add_wc_form_element_tab( $form_fields, $field_type, $field_id ) {
		...
		$form_fields['WC4BP-Groups']['hide_wc4bp_groups'] = new Element_Checkbox(
			'<b>' . __( 'Tab WC4BP Groups: ', 'buddyforms' ) . '</b>',
			'buddyforms_options[form_fields][' . $field_id . '][hide_wc4bp_groups]',
			array( 'hidden' => __( 'Hide WC4BP Groups Tab', 'buddyforms' ) ),
			array(
