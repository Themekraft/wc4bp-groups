...
?>
<div id="<?php echo esc_attr( wc4bp_groups_manager::getSlug() ); ?>" class="panel woocommerce_options_panel wc-metaboxes-wrapper">
	...
	<?php else : ?>
		...
		<div class="<?php echo esc_attr( wc4bp_groups_manager::getSlug() ); ?> wc4bp-group-container wc-metaboxes ui-sortable">
			<?php
			$added_groups = array();
			if ( ! empty( $groups ) ) {
