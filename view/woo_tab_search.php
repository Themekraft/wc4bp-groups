<p class="form-field">
    ...
    <label for="wc4bp-group-ids"><?php wc4bp_groups_manager::_e_wc4bp_groups( 'Select groups to add' ); ?></label>
    <input type="hidden" class="wc4bp-group-search" style="width: 50%;" id="wc4bp-group-ids" name="wc4bp-group-ids"
           data-placeholder="<?php wc4bp_groups_manager::esc_attr_e_wc4bp_groups( 'Search for a group' ); ?>" data-action="wc4bp_group_search"
    ...
    <button type="button" class="button wc4bp add_groups"><?php wc4bp_groups_manager::_e_wc4bp_groups( 'Add Group' ); ?></button>
